...
@section('title',__('shop/pages/products.all_offers'))
@section('content')
<div class="new-products" id="offers">
    <div class="container">
        <div class="section-title">
            <h2 class="title">
                {{__('shop/pages/products.all_offers')}}
            </h2>
        </div>
        <div class="products">
                ...
                <div class="product-item">
                    ...
                    <div class="col-9">
                        ...
                        <div class="item-price">
                            <span><div class="new-price">{{$product->price}}{{__('shop/global.currency')}}</div>  <del class="old_price">{{$product->old_price}}{{__('shop/global.currency')}}</del></span>
                        </div>
                    </div><div class="col-3">
