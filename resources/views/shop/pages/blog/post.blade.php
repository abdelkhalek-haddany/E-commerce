...
<div class="single-post">
    ...
    <div class="container breadcrumbs">
        <span><a href="{{route("posts")}}"> {{__("shop/pages/blog/posts.page_title")}} </a></span>
        ...
        <article class="article">
            ...
            <div class="article-content">
                {!! $post->details !!}
                <p class="t">
                    {{__("shop/pages/blog/post.thanks")}}
                </p>
            </div>
            <div class="post-meta">
                <span> <a href="{{route('about')}}">( {{__("shop/pages/blog/post.by")}}. {{user($post->user_id)->first_name}} {{user($post->user_id)->last_name}} )</a></span>
            </div>    
                </div>
            
                <div class="post-tags">
                    <h4>{{__("shop/pages/blog/globale.tags")}}</h4>
                ...
                <div class="post-share">
                    <h4>{{__("shop/pages/blog/post.share_post")}}</h4>
                    <a class="icon-facebook"
                        href="https://www.facebook.com/sharer/sharer.php?u={{url()->full()}}" 
                        target="_blank">{{__("shop/pages/blog/post.facebook")}}</a>
                    <a class="icon-twitter"
                        href="https://twitter.com/share?text='{{$post->title}}'&url={{url()->full()}}" 
                        target="_blank">{{__("shop/pages/blog/post.twitter")}}</a>
                    ...
                    target="_blank">{{__("shop/pages/blog/post.linkedin")}}</a>
                </div>
                    ...
                    @else
                    <span class='desibled'><i class='fas fa-chevron-left' aria-hidden='true'></i> {{__("shop/pages/blog/globale.previous_single")}}</span>
                    @endif
                </div>
                </div>
            <div class="col-sm-6 col-xm-12">
                    ...
                    @else
                    <span class='desibled'>{{__("shop/pages/blog/globale.next_single")}} <i class='fas fa-chevron-right' aria-hidden='true'></i></span>
                    @endif
                </div>    
            </div>
        </div>
...
<!--<script type="text/javascript" src="https://platform.foremedia.net/code/7217/footer"></script>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="col-md-4">-->
<!--            <div class="card">-->
