...
@section('title', __('shop/pages/products.all_hot_deals'))
@section('content')
    <div class="hot-deals" id="hot_deals">
        <div class="container">
            <div class="section-title">
                <h2 class="title">
                    {{ __('shop/pages/products.all_hot_deals') }}
                </h2>
            </div>
            <div class="products">
                            ...
                            <div class="product-item">
                                ...
                                <div class="item-body">
                                    <div class="count-operations">
                                        <countdown-timer startsAt="{{ $product->startsAt }}"
                                            endsAt="{{ $product->endsAt }}"></countdown-timer>
                                    </div>
