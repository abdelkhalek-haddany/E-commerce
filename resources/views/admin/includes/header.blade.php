    ...
    <div class="navbar-wrapper">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="/">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('assets/images/shop/logo.png')}}">
                        <h3 class="brand-text">{{Auth::user()->company_name}}</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">
                  <span
                      class="user-name text-bold-700">{{Auth::user()->company_name}}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="{{Auth::user()->logo}}" alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('profile')}}"><i
                                    class="ft-user"></i>{{__('admin/globale.profile')}}</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route("logout")}}"><i class="ft-power"></i>
                                {{__('admin/globale.logout')}}</a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link" href="{{url("/admin/messages")}}"><i
