                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('vendors.index')}}">{{__('admin/globale.vendors')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/globale.edit')}}{{__('admin/globale.vendor')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/globale.edit')}}{{__('admin/globale.vendor')}}</h4>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="first_name"
                                                                       class="form-control @error('first_name') is-invalid @enderror"value="{{ $vendor->first_name }}"
                                                                       name="first_name"
                                                                       >
                                                                @error("first_name")
                                                                <span class="text-danger">{{$message}}</span>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="last_name"
                                                                       class="form-control @error('last_name') is-invalid @enderror"value="{{ $vendor->last_name }}"
                                                                       name="last_name"
                                                                       >
                                                                @error("last_name")
                                                                <span class="text-danger">{{$message}}</span>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="brand"
                                                                               class="form-control @error('brand') is-invalid @enderror"value="{{$vendor->company_name}}"
                                                                               name="company_name"
                                                                               >
                                                                        @error("brand")
                                                                        <span class="text-danger">{{$message}}</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$vendor->country}}" id="country"
                                                                   class="form-control"
                                                                   placeholder="country"
                                                                   name="country">
                                                            @error('name')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$vendor->city}}" id="city"
                                                                   class="form-control"
                                                                   placeholder="city"
                                                                   name="city">
                                                            @error('name')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$vendor->province}}" id="province"
                                                                   class="form-control"
