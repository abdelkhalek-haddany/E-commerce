                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('products.index')}}">{{__('admin/globale.products')}}</a>
                                </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                            ...
                                            <form enctype="multipart/form-data" class="form" action="{{ url('admin/products/store') }}" method="POST">
                                            @csrf
