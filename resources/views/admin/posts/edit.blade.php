                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('posts.index')}}">{{__('admin/globale.posts')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('admin/globale.edit')}}{{__('admin/globale.post')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">{{__('admin/globale.edit')}}{{__('admin/globale.post')}}</h4>
                                        ...
                                        <form class="form" action="{{route('posts.update', $post->id)}}" method="POST"
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <h4 class="form-section"><i class="ft-home"></i>{{__('admin/globale.post_info')}}</h4>
                        ...
                        <div class="form-group @if($errors->has('lang')) has-error @endif">
                            ...
                            {!! Form::text('lang', $post->lang, ['class' => 'form-control', 'placeholder' => 'Lang']) !!}
                            @if ($errors->has('lang'))
                                <span class="text-danger">{!! $errors->first('lang') !!}</span>@endif
                        </div>
                        ...
                        <div class="col-md-12">
                        <div class="form-group @if($errors->has('expert')) has-error @endif">
                            {!! Form::label(__('admin/globale.expert')) !!}
                            {!! Form::text('expert', $post->expert, ['class' => 'form-control', 'placeholder' => 'expert']) !!}
                            @if ($errors->has('expert'))
                                <span class="text-danger">{!! $errors->first('expert') !!}</span>@endif
                        </div>
                        </div>

                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="main-label" for="size"> {{__('admin/globale.tags')}} </label>
                                <div class="tags">
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            ...
                            {!! Form::textarea('details', $post->details, ['class' => 'form-control', 'id'=> 'editor', 'placeholder' => 'Details']) !!}
