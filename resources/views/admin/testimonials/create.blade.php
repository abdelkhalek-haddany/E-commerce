                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('admin/globale.create')}}{{__('admin/globale.testimonial')}}
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        {{__('admin/globale.create')}}{{__('admin/globale.testimonial')}}
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            {!! Form::text('name',null, ['class'=>'form-control','multiple'=>'multiple']) !!}
                        ...
                        <div class="form-group @if($errors->has('opinion')) has-error @endif">
                            ...
                            {!! Form::textarea('opinion', null, ['class' => 'form-control', 'id'=> 'editor']) !!}
