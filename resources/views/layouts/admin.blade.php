...
<head>
    ...
    {{-- <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/custom.css')}}"> for rtl --}}
    <!-- END MODERN CSS-->
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('assets/admin/js/scripts/jquery.min.js')}}"
...
<script src="{{asset('assets/admin/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"
        type="text/javascript"></script>
        <script src="{{asset('assets/admin/js/scripts/bootstrap.min.js')}}"
        type="text/javascript"></script>
